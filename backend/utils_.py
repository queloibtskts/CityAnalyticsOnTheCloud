...
def countTweetsByStateJson_to_CSV2(clean_countTweetByStates, vulgar_countTweetByStates):
    ...
    'NT': 'Northern Territory', 'QLD': 'Queensland', 'TAS': 'Tasmania', 'WA': 'Western Australia',
    'SA': 'South Australia'}
...
def countTweetsByStateJson_to_CSV(clean_countTweetByStates, vulgar_countTweetByStates):
            ...
            toDF = {'state': col_state, 'state_abbrevs': col_state_abbrevs,
                    'n_explicit': col_freq_explicit, 'n_total': col_freq_total}
